          ...
          <div className="col-lg-5 col-md-8">
            ...
            >
              ...
              <div style={{ padding: '24px' }}>
                ...
                >
                  <span style={{ color: 'var(--c-text-soft)', fontSize: '15px' }}>
                    Mã nạp/đơn hàng
                  </span>
                ...
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setInputValues({ ...inputValues, orderDescription: e.target.value })
                    }
                    type="text"
                    style={{
                      width: '100%',
                ...
                >
                  <i
                    ...
                    style={{ color: '#1890ff', fontSize: '20px', marginTop: '2px' }}
                  ></i>
                  <p
                    style={{
                      margin: 0,
                  ...
                  >
                    Bạn sẽ được chuyển hướng đến cổng thanh toán bảo mật của VNPAY. Bạn có thể chọn
                    thẻ ATM, thẻ tín dụng hoặc ứng dụng Ngân hàng trên trang tiếp theo.
                  </p>
                </div>
