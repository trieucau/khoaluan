      ...
      <div className="container" style={{ flex: 1, paddingBottom: '60px' }}>
        <div className="row justify-content-center">
          <div className="col-lg-5 col-md-8">
            ...
            >
              ...
              <div
                style={{
                  ...
                  textAlign: 'center',
                  background:
                    status === 'success' ? '#fafafa' : status === 'failed' ? '#fff1f0' : '#fff',
                }}
              >
                {status === 'loading' && (
                  <>
                    ...
                    >
                      <i
                        ...
                        style={{ fontSize: '24px', color: 'var(--c-primary)' }}
                      ></i>
                    </div>
                    <h2
                      style={{
                    ...
                    <p style={{ margin: 0, color: 'var(--c-text-soft)', fontSize: '14px' }}>
                      Vui lòng giữ nguyên trang web
                    </p>
                  </>
                )}
                ...
                {status === 'failed' && (
                  <>
                    ...
                    <p style={{ margin: 0, color: '#cf1322', fontSize: '14px' }}>
                      Bạn đã hủy giao dịch hoặc có lỗi xảy ra
                    </p>
                  </>
                )}
              </div>
              ...
              {paymentInfo && status !== 'loading' && (
                <div style={{ padding: '24px 32px' }}>
                  ...
                  >
                    <span style={{ color: 'var(--c-text-soft)', fontSize: '14px' }}>
                      Mã tham chiếu
                    </span>
                  ...
                  >
                    ...
                    <span style={{ color: 'var(--c-text)', fontSize: '14px', fontWeight: '600' }}>
                      VNPAY {paymentInfo.vnp_BankCode ? `(${paymentInfo.vnp_BankCode})` : ''}
                    </span>
                  </div>
            ...
            {status !== 'loading' && (
              <div
                style={{ marginTop: '24px', display: 'flex', gap: '12px', flexDirection: 'column' }}
              >
                <button
