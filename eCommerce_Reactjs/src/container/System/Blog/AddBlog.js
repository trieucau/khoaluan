        ...
        <div className="ap-page-header-row">
          <div>
            <div className="ap-page-title">
              {isAdd ? (
                <>
                  <i className="fa-solid fa-pen-nib" style={{ marginRight: 8 }}></i>Tạo bài đăng
                </>
              ) : (
                <>
                  <i className="fa-solid fa-pen-to-square"></i>Chỉnh sửa bài đăng
                </>
              )}
            </div>
            <div className="ap-page-subtitle">
              {isAdd ? 'Viết bài blog mới' : 'Cập nhật nội dung bài viết'}
            </div>
          </div>
      ...
      <div className="ap-card">
        <div className="ap-card-header">
          <span className="ap-card-title">
            <i className="fa-solid fa-pen-to-square" style={{ marginRight: 8 }}></i>Thông tin bài
            viết
          </span>
        </div>
        <div className="ap-card-body">
          ...
          <div className="ap-form-row" style={{ alignItems: 'flex-start' }}>
            <div className="ap-form-group" style={{ flex: 2 }}>
              ...
              />
              <div style={{ fontSize: 12, color: 'var(--ap-text-dim)', marginTop: 4 }}>
                JPG, PNG, WEBP · tối đa 30MB
              </div>
            </div>
            {values.imageReview && (
              <div className="ap-form-group">
