  ...
  return (
    <div className="ap-page">
      <PageHeader
        title={
          <>
            <i className="fa-solid fa-box" style={{ marginRight: 8 }}></i>Quản lý nhập hàng
          </>
        }
        subtitle="Lịch sử phiếu nhập hàng từ nhà cung cấp"
        actions={
          <>
            ...
            <Link to="/admin/add-receipt" className="ap-btn ap-btn-primary">
              + Tạo phiếu nhập
            </Link>
          </>
        }
              ...
              {loading ? (
                ...
                data.map((item, idx) => (
                  ...
                  >
                    ...
                    <td
                      style={{ fontSize: 12, color: 'var(--ap-text-muted)', whiteSpace: 'nowrap' }}
                    >
                    ...
                    <td style={{ textAlign: 'center' }}>
                      <Link
                        to={`/admin/detail-receipt/${item.id}`}
