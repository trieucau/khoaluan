        ...
        <div className="ap-card-body">
          <div className="ap-form-row">
            <div className="ap-form-group">
              ...
              <input className="ap-input" name="value" value={values.value} onChange={handleChange} placeholder="VD: Áo thun, Quần jean..." />
            </div>
            <div className="ap-form-group">
              <label className="ap-label">Mã code *</label>
              <input className="ap-input" name="code" value={values.code} onChange={handleChange} placeholder="VD: AOT, QJ..." style={{ textTransform: 'uppercase' }} />
            </div>
          </div>
          <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
            ...
            <Link to="/admin/list-category" className="ap-btn ap-btn-ghost">Hủy</Link>
          </div>
        </div>
      </div>
    </div>
