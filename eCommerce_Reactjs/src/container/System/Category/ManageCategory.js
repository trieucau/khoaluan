  ...
  return (
    <div className="ap-page">
      <PageHeader
        title={
          <>
            <i className="fa-solid fa-list-check" style={{ marginRight: 8 }}></i>Quản lý danh mục
          </>
        }
        ...
        actions={
          <>
            ...
            <Link to="/admin/add-category" className="ap-btn ap-btn-primary">
              + Thêm danh mục
            </Link>
          </>
        }
              ...
              {loading ? (
                ...
                data.map((item, idx) => (
                  ...
                  >
                    ...
                    <td>
                      <span className="ap-badge ap-badge-indigo">{item.code}</span>
                    </td>
                    <td>
