  ...
  return (
    <div className="ap-page">
      <PageHeader
        title={
          <>
            <i className="fa-solid fa-image" style={{ marginRight: 8 }}></i>Quản lý Banner
          </>
        }
        subtitle="Danh sách hình ảnh quảng cáo trang chủ"
        actions={
          <>
            ...
            <Link to="/admin/add-banner" className="ap-btn ap-btn-primary">
              + Thêm banner
            </Link>
          </>
        }
