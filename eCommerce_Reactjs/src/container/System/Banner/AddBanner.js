    ...
    <div className="ap-page">
        ...
        <div className="ap-page-header-row">
          <div>
            <div className="ap-page-title">
              {isAdd ? (
                <>
                  <i className="fa-solid fa-image" style={{ marginRight: 8 }}></i>Thêm Banner
                </>
              ) : (
                <>
                  <i className="fa-solid fa-pen-to-square"></i>Cập nhật Banner
                </>
              )}
            </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 20 }}>
        <div className="ap-card">
          <div className="ap-card-header">
            <span className="ap-card-title">
              <i className="fa-solid fa-list-check" style={{ marginRight: 8 }}></i>Thông tin Banner
            </span>
          </div>
          <div className="ap-card-body">
            <div className="ap-form-group">
              ...
              <input
                ...
                placeholder="VD: Banner mùa hè 2025..."
              />
            </div>
            <div className="ap-form-group">
        ...
        <div className="ap-card">
          <div className="ap-card-header">
            <span className="ap-card-title">
              <i className="fa-solid fa-image" style={{ marginRight: 8 }}></i>Hình ảnh
            </span>
          </div>
          <div className="ap-card-body">
            <input
