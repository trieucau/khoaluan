  ...
  return (
    <div className="ap-page">
      <PageHeader
        title={
          <>
            <i className="fa-solid fa-book" style={{ marginRight: 8 }}></i>Quản lý chủ đề
          </>
        }
        subtitle="Danh sách chủ đề bài đăng blog"
        actions={
          <>
            ...
            <Link to="/admin/add-subject" className="ap-btn ap-btn-primary">
              + Thêm chủ đề
            </Link>
          </>
        }
              ...
              {loading ? (
                ...
                data.map((item, idx) => (
                  ...
                  >
                    ...
                    <td>
                      <span className="ap-badge ap-badge-cyan">{item.code}</span>
                    </td>
                    <td>
                      <div style={{ display: 'flex', gap: 6, justifyContent: 'center' }}>
                        <Link
                          to={`/admin/edit-subject/${item.id}`}
