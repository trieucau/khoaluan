  ...
  return (
    <div className="ap-page">
      <PageHeader
        title={
          <>
            <i className="fa-solid fa-copyright" style={{ marginRight: 8 }}></i>Quản lý nhãn hàng
          </>
        }
        subtitle="Danh sách thương hiệu sản phẩm"
        actions={
          <>
            ...
            <Link to="/admin/add-brand" className="ap-btn ap-btn-primary">
              + Thêm nhãn hàng
            </Link>
          </>
        }
            ...
            <tbody>
              {loading ? (
                ...
                <EmptyState
                  icon={
                    <>
                      <i className="fa-solid fa-copyright" style={{ marginRight: 8 }}></i>
                    </>
                  }
                  title="Không có nhãn hàng nào"
                />
              ) : (
                data.map((item, idx) => (
                  <tr
                  ...
                  >
                    ...
                    <td>
                      <span className="ap-badge ap-badge-purple">{item.code}</span>
                    </td>
                    <td>
