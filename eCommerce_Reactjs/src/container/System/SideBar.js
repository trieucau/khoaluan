...
const NavGroup = ({ icon, label, children, defaultOpen = false, location }) => {
  ...
  return (
    <div className="ap-nav-group">
      <button
        className={`ap-nav-group-header${open ? ' open' : ''}`}
        onClick={() => setOpen((v) => !v)}
      >
        {icon}
        <span>{label}</span>
  ...
  return (
    <nav className="ap-sidebar-nav">
      <div className="ap-nav-section">
        ...
        <Link
          to="/admin"
          className={`ap-nav-link${location.pathname === '/admin' ? ' active' : ''}`}
          onClick={lc}
        >
          {Icons.dashboard}
      ...
      {isAdmin && (
        <div className="ap-nav-section">
          ...
          <NavGroup
            ...
            label="Danh mục"
            location={location}
            defaultOpen={location.pathname.includes('/category')}
          >
            <NavChild
          ...
          <NavGroup
            ...
            label="Nhãn hàng"
            location={location}
            defaultOpen={location.pathname.includes('/brand')}
          >
          ...
          <NavGroup
            ...
            label="Sản phẩm"
            location={location}
            defaultOpen={location.pathname.includes('/product')}
          >
          ...
          <NavGroup
            ...
            label="Banner"
            location={location}
            defaultOpen={location.pathname.includes('/banner')}
          >
          ...
          <NavGroup
            ...
            label="Chủ đề"
            location={location}
            defaultOpen={location.pathname.includes('/subject')}
          >
          ...
          <NavGroup
            ...
            label="Bài đăng"
            location={location}
            defaultOpen={location.pathname.includes('/blog')}
          >
          ...
          <NavGroup
            ...
            label="Loại ship"
            location={location}
            defaultOpen={location.pathname.includes('/typeship')}
          >
            <NavChild
          ...
          <NavGroup
            ...
            label="Voucher"
            location={location}
            defaultOpen={location.pathname.includes('/voucher')}
          >
            <NavChild
      ...
      <div className="ap-nav-section">
        ...
        <NavGroup
          ...
          label="Nhà cung cấp"
          location={location}
          defaultOpen={location.pathname.includes('/supplier')}
        >
        ...
        <NavGroup
          ...
          label="Nhập hàng"
          location={location}
          defaultOpen={location.pathname.includes('/receipt')}
        >
        ...
        <NavGroup
          ...
          label="Đơn hàng"
          location={location}
          defaultOpen={location.pathname.includes('/order')}
        >
        ...
        <Link
          to="/admin/chat"
          className={`ap-nav-link${location.pathname === '/admin/chat' ? ' active' : ''}`}
          onClick={lc}
        >
          {Icons.chat}
          <span>Tin nhắn</span>
