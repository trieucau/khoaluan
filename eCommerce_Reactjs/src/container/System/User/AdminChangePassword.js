...
const AdminChangePassword = () => {
  ...
  const inputStyle = (extra = {}) => ({
    width: '100%', background: 'var(--ap-surface2)', border: '1px solid var(--ap-border)',
    borderRadius: 8, padding: '10px 44px 10px 13px', color: 'var(--ap-text-primary)',
  ...
  return (
    <div className="ap-page">
      ...
      <div className="ap-page-header">
        <div className="ap-page-header-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', width: '100%' }}>
          <div>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <Link to={`/admin/infor/${id}`} className="ap-btn ap-btn-ghost">← Thông tin</Link>
      ...
      <div style={{ maxWidth: 460 }}>
        <div className="ap-card">
          <div className="ap-card-header"><span className="ap-card-title">🔐 Cập nhật mật khẩu</span></div>
          <div className="ap-card-body">

            {/* Tips */}
            <div style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.2)', borderRadius: 8, padding: '10px 14px', marginBottom: 20, fontSize: 12, color: 'var(--ap-text-dim)', lineHeight: 1.7 }}>
              💡 Mật khẩu mạnh nên có <b>ít nhất 10 ký tự</b>, bao gồm chữ hoa, chữ thường và số.
            </div>

            {/* Old password */}
            <div style={{ marginBottom: 16, position: 'relative' }}>
              <label className="ap-form-label" style={{ display: 'block', marginBottom: 6, fontSize: 13, color: 'var(--ap-text-secondary)' }}>Mật khẩu hiện tại *</label>
            ...
            {/* New password */}
            <div style={{ marginBottom: 16, position: 'relative' }}>
              <label className="ap-form-label" style={{ display: 'block', marginBottom: 6, fontSize: 13, color: 'var(--ap-text-secondary)' }}>Mật khẩu mới *</label>
            ...
            <div style={{ marginBottom: 20, position: 'relative' }}>
              <label className="ap-form-label" style={{ display: 'block', marginBottom: 6, fontSize: 13, color: 'var(--ap-text-secondary)' }}>Xác nhận mật khẩu mới *</label>
            ...
            <button className="ap-btn ap-btn-primary" onClick={handleSave}
              disabled={loading || !!mismatch} style={{ width: '100%', justifyContent: 'center', minHeight: 44, display: 'flex', alignItems: 'center' }}>
