...
const ManageUser = () => {
  ...
  const handleDelete = async (e, id) => {
    ...
    if (res?.errCode === 0) {
      ...
      fetchAllUser(keyword, numberPage * PAGINATION.pagerow);
    ...
    <div className="ap-page">
        ...
        <div className="ap-page-header-row">
          <div>
            <div className="ap-page-title">
              <i className="fa-solid fa-users" style={{ marginRight: 8 }}></i>Quản lý người dùng
            </div>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <Link to="/admin/add-user" className="ap-btn ap-btn-primary">
              + Thêm mới
            </Link>
          </div>
        </div>
      ...
      <div className="ap-card">
        <div className="ap-toolbar">
          ...
          <button className="ap-btn ap-btn-primary ap-btn-sm" onClick={handleSearch}>
            Tìm kiếm
          </button>
        </div>
            ...
            <tbody>
              {loading ? (
                ...
                dataUser.map((item, idx) => {
                  const role = ROLE_BADGE[item.roleId] || {
                    label: item.roleData?.value,
                    cls: 'ap-badge-gray',
                  };
                  const initials =
                  ...
                  return (
                    ...
                    >
                      ...
                      <td>
                        <span className={`ap-badge ${role.cls}`}>{role.label}</span>
                      </td>
                      <td>
