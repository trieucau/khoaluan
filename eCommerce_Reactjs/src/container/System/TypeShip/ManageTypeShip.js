  ...
  return (
    <div className="ap-page">
      <PageHeader
        title={
          <>
            <i className="fa-solid fa-truck-fast" style={{ marginRight: 8 }}></i>Quản lý loại giao
            hàng
          </>
        }
        subtitle="Cấu hình các loại hình vận chuyển"
        actions={
          <>
            ...
            <Link to="/admin/add-typeship" className="ap-btn ap-btn-primary">
              + Thêm loại ship
            </Link>
          </>
        }
      ...
      <div className="ap-card">
        <SearchBar
          ...
          placeholder="Tìm theo tên loại ship..."
        />
                  ...
                  >
                    ...
                    <td>
                      <div style={{ display: 'flex', gap: 6, justifyContent: 'center' }}>
                        <Link
                          to={`/admin/edit-typeship/${item.id}`}
