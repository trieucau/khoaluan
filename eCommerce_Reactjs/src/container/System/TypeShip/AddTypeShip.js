        ...
        <div className="ap-page-header-row">
          <div>
            <div className="ap-page-title">
              {isAdd ? (
                <>
                  <i className="fa-solid fa-plus" style={{ marginRight: 6 }}></i>Thêm loại giao hàng
                </>
              ) : (
                <>
                  <i className="fa-solid fa-pen-to-square"></i>Cập nhật loại giao hàng
                </>
              )}
            </div>
      ...
      <div className="ap-card" style={{ maxWidth: 560 }}>
        <div className="ap-card-header">
          <span className="ap-card-title">
            <i className="fa-solid fa-truck-fast" style={{ marginRight: 8 }}></i>Thông tin loại giao
            hàng
          </span>
        </div>
          ...
          <div className="ap-form-row">
            <div className="ap-form-group">
              ...
              <input
                ...
                placeholder="VD: Giao nhanh, Giao tiêu chuẩn..."
              />
            </div>
            <div className="ap-form-group">
