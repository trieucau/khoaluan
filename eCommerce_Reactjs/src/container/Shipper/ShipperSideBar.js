...
const NAV_ITEMS = [
  ...
  { to: '/shipper/profile', icon: (<svg className="sp-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>), label: 'Thông tin cá nhân' },
  { to: '/shipper/change-password', icon: (<svg className="sp-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>), label: 'Đổi mật khẩu' },
...
const ShipperSideBar = ({ onLinkClick, availableCount = 0, activeCount = 0 }) => {
  ...
  return (
    <nav className="sp-sidebar-nav">
      ...
      <div className="sp-nav-scroll-area sp-hide-scrollbar" style={{ flex: 1, overflowY: 'auto', paddingBottom: 20 }}>
        <div className="sp-nav-section">
          ...
          {/* Logout button at the end of the list */}
          <div className="sp-nav-link" onClick={handleLogout} style={{ color: '#fca5a5', cursor: 'pointer', marginTop: 12 }}>
      ...
      <div className="sp-sidebar-footer" style={{ borderTop: '1px solid var(--sp-border)', paddingTop: 16, paddingBottom: 24 }}>
