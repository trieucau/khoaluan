      ...
      getDetailUserById(userData.id).then((res) => {
        if (res?.errCode === 0 && res.data?.image) {
          ...
          if (img && typeof img === 'object' && img.data) {
            ...
            img = base64String.startsWith('data:image')
              ? base64String
    ...
    <nav className="sp-sidebar-nav">
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            {user.email || 'shipper@email.com'}
          </div>
        </div>
      </div>

      <div
        className="sp-nav-scroll-area sp-hide-scrollbar"
      ...
      >
        <div className="sp-nav-section">
          ...
          <div
            ...
            style={{ color: '#fca5a5', cursor: 'pointer', marginTop: 12 }}
          >
            <svg
              className="sp-nav-icon"
              viewBox="0 0 24 24"
      ...
      <div
        ...
        style={{ borderTop: '1px solid var(--sp-border)', paddingTop: 16, paddingBottom: 24 }}
      >
