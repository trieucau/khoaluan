...
const ActiveOrderWidget = ({
  ...
  if (!order) {
    return (
      ...
      >
        ...
        <div style={{ fontSize: 10, color: 'var(--sp-text-dim)', marginTop: 4 }}>
  ...
  return (
    <div
      className="sp-glass-panel sp-active-order-card"
      style={{
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: 16, fontWeight: 900, color: '#10b981' }}>
            {formatMoney(order.typeShipData?.price || 30000)}
          </span>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ position: 'relative', paddingLeft: 40, marginBottom: isMobile ? 28 : 20 }}>
          <div
            style={{
              ...
              width: 2,
              background:
                'repeating-linear-gradient(to bottom, transparent, transparent 4px, rgba(255,255,255,0.1) 4px, rgba(255,255,255,0.1) 8px)',
              borderRadius: 1,
            }}
          />
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ fontSize: 13, color: '#fff', fontWeight: 700, lineHeight: 1.4 }}>
              {order.addressUser?.shipAdress || 'Địa chỉ khách'}
            </div>
          </div>
        </div>
        ...
        >
          <a
            href={`tel:${order.addressUser?.phoneNumber || ''}`}
