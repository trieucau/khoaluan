  ...
  return (
    <div className="">
      <Modal
        ...
        className={'booking-modal-container voucher-modal'}
        size="md"
        centered
      >
        <div
        ...
        >
          ...
          >
            <i
              ...
              style={{ color: 'var(--c-primary)', marginRight: '10px' }}
            ></i>
        ...
        >
          <button
            ...
            onMouseOver={(e) => {
              e.currentTarget.style.borderColor = 'var(--c-text-soft)';
              e.currentTarget.style.color = 'var(--c-text)';
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.borderColor = 'var(--c-border-strong)';
              e.currentTarget.style.color = 'var(--c-text-soft)';
            }}
          >
            Trở lại
          </button>
