        ...
        s.each(function () {
          ...
          (s.data('stellar-backgroundStartingLeft')
            ...
            t.backgrounds.push({
              ...
              parentOffsetTop: b,
              stellarRatio:
                s.data('stellar-background-ratio') === r ? 1 : s.data('stellar-background-ratio'),
            }));
        }));
    },
    _reset: function () {
          ...
          this.options.hideDistantElements &&
            ((l =
              ...
              (d + i.width > (i.isFixed ? 0 : e) &&
                d < (i.isFixed ? 0 : e) + this.viewportWidth + this.viewportOffsetLeft)),
            (f =
              !this.options.verticalScrolling ||
              (v + i.height > (i.isFixed ? 0 : t) &&
                v < (i.isFixed ? 0 : t) + this.viewportHeight + this.viewportOffsetTop))),
          l && f
  ...
  (function () {
    ...
    for (var j = 0; j < l.length && !f.requestAnimationFrame; ++j) {
      ...
      f.cancelAnimationFrame =
        f[l[j] + 'CancelAnimationFrame'] || f[l[j] + 'CancelRequestAnimationFrame'];
    }
